    ...
    <div class="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-4 gap-6 mt-6">
        ...
        <aside class="hidden lg:block col-span-1">
            <div class="bg-white p-4 rounded-lg shadow">
                ...
                <div class="flex flex-col items-center">
                    <img src="https://randomuser.me/api/portraits/women/44.jpg" class="w-24 h-24 rounded-full mb-4"
                        alt="Foto de perfil">
        ...
        <section class="col-span-1 lg:col-span-2 max-w-3xl mx-auto">
            ...
            <div class="flex items-center bg-white rounded-lg shadow p-3 gap-4 mb-4">
                ...
                <button
                    class="border border-gray-300 text-gray-700 px-4 py-1 rounded-full text-sm font-semibold hover:bg-gray-100">Proyectos</button>
                <button
                    class="border border-gray-300 text-gray-700 px-4 py-1 rounded-full text-sm font-semibold hover:bg-gray-100">Menciones</button>
            </div>
            ...
            <div class="space-y-4 bg-white p-4 rounded-lg shadow">
                ...
                <div class="flex items-start gap-3 bg-blue-100 p-4 rounded-lg shadow relative">
                    ...
                    <div class="flex-1">
                        <p class="text-gray-800 text-sm font-semibold">
                            Los riesgos de la hiperfijación; Tu mascota influye en tu salud mental más de lo que crees, y
                            más
                        </p>
                    </div>
                ...
                <div class="flex flex-col gap-2 bg-blue-100 p-4 rounded-lg shadow relative">
                    <div class="flex items-start gap-3">
                        <img src="https://robohash.org/gap?size=60x60" alt="GAP Logo"
                            class="w-10 h-10 rounded-full object-cover">
                        <div class="flex-1">
                            <p class="text-gray-800 text-sm font-semibold">
                    ...
                    <div class="flex justify-end">
                        <button
                            class="text-blue-600 text-sm font-semibold border border-blue-600 rounded-full px-4 py-1 hover:bg-blue-50">
                            Ver proyectos
                        </button>
                    </div>
                </div>
