    ...
    <div class="max-w-7xl mx-auto flex flex-col min-h-screen">
      ...
      <header class="w-full flex justify-between items-center px-10 py-4">
        ...
        <nav class="hidden md:flex items-center space-x-8 text-md font-medium">
          ...
          <a href="{{ route('showForm', ['type' => 'login']) }}" class="text-blue-600 font-semibold">Iniciar sesión</a>
          <a href="{{ route('showForm', ['type' => 'register']) }}" class="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg text-md">Registrar</a>
        </nav>
      </header>
