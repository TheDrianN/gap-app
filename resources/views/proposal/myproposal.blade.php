...
<!-- Mi propuesta -->
<div class="space-y-6">
    <h2 class="text-lg font-bold text-gray-800">Mi Propuesta</h2>
        ...
        <div class="space-y-6 text-sm">
            ...
            <div class="flex gap-3">
                ...
                <div>
                    <p class="font-bold text-gray-800 flex items-center gap-2">
                        LeapStores
                        <span class="text-gray-400 text-xs">23/04/2025 14:32</span>
                    </p>
                    <p class="mt-1 text-gray-700">
                        Gracias por tu propuesta. Me interesa tu enfoque con Apache Airflow. ¿Podrías compartir más detalles?
                    </p>
                </div>
            </div>
            ...
            <div class="flex gap-3">
                ...
                <div>
                    <p class="font-bold text-blue-600 flex items-center gap-2">
                        Yo
                        <span class="text-gray-400 text-xs">23/04/2025 15:18</span>
                    </p>
                    <p class="mt-1 text-gray-700">
                        Hola Laura, para archivos de ese tamaño recomendaría utilizar PySpark en lugar de Pandas, ya que permite procesamiento distribuido. 
                        Podríamos configurar un clúster pequeño para manejar esa carga. 
                        También implementaría procesamiento por lotes y técnicas de particionamiento para optimizar el rendimiento. 
                        ¿Les gustaría que preparara una propuesta específica para este escenario?
                    </p>
                </div>
            </div>
            ...
            <div class="flex gap-3">
                ...
                <div>
                    <p class="font-bold text-gray-800 flex items-center gap-2">
                        LeapStores
                        <span class="text-gray-400 text-xs">24/04/2025 09:45</span>
                    </p>
                    <p class="mt-1 text-gray-700">
                        Sí, eso sería útil. Estamos evaluando varias propuestas, pero tu enfoque parece alinearse bien con nuestras necesidades. 
                        Te contactaré pronto con más información.
                    </p>
                </div>
            </div>
    ...
    <aside class="col-span-1 space-y-6">
        ...
        <div class="bg-white p-6 rounded-lg shadow space-y-3">
            ...
            <button class="w-full bg-blue-600 hover:bg-blue-700 text-white font-semibold text-sm px-4 py-2 rounded-lg">
                Editar propuesta
            </button>
